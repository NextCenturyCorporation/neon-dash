...
var ErrorNotificationService = /** @class */ (function () {
    function ErrorNotificationService() {
    }
    ErrorNotificationService.prototype.showErrorMessage = function (error, message) {
        // TODO: Replace testing log with a call to MatSnackBar to
        console.error('An error occured: ' + message + '\n' + error);
    };
    ErrorNotificationService = __decorate([
        Injectable()
