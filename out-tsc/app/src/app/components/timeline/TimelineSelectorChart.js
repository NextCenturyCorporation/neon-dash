...
export { TimelineData };
var TimelineSelectorChart = /** @class */ (function () {
    function TimelineSelectorChart(tlComponent, element, data) {
    ...
    TimelineSelectorChart.prototype.redrawChart = function () {
     ...
     */
    TimelineSelectorChart.prototype.toggleFocus = function (showFocus) {
        if (showFocus) {
    ...
    TimelineSelectorChart.prototype.determineWidth = function () {
        var elemWidth = this.element.nativeElement.getBoundingClientRect().width;
        return elemWidth > 0 ? elemWidth : DEFAULT_WIDTH;
    };
    TimelineSelectorChart.prototype.determineHeight = function () {
    ...
    TimelineSelectorChart.prototype.clearBrush = function () {
        this.data.extent = [];
        this.oldExtent = [];
        this.brush.clear();
    ...
    TimelineSelectorChart.prototype.datesEqual = function (a, b) {
        return a.toUTCString() === b.toUTCString();
    };
    TimelineSelectorChart.prototype.renderExtent = function () {
    ...
    TimelineSelectorChart.prototype.render = function () {
        var _this = this;
        var i = 0;
        ...
        var createSeries = function (series) {
            ...
            var focusChart = _this.drawFocusChart(series);
    ...
    TimelineSelectorChart.prototype.drawFocusChart = function (series) {
        var _this = this;
        var MIN_VALUE = this.data.logarithmic ? 1 : 0;
    ...
    TimelineSelectorChart.prototype.updateMask = function () {
        var _this = this;
        // Snap brush
        if (d3.event) {
     ...
     */
    TimelineSelectorChart.prototype.findHoverIndexInData = function (data, domain) {
     ...
     */
    TimelineSelectorChart.prototype.onHover = function (datum) {
     ...
     * @param datum
     */
    TimelineSelectorChart.prototype.onFocusHover = function (datum) {
     ...
     * @method onHoverEnd
     */
    TimelineSelectorChart.prototype.onHoverEnd = function () {
        this.clearHighlights();
        this.hideTooltip();
    };
    /**
     ...
     */
    TimelineSelectorChart.prototype.showFocusMultiHighlight = function (startDate, endDate) {
     ...
     * xRange and yRange functions (xContext/yContext or xFocus/yFocus).
     */
    TimelineSelectorChart.prototype.showHighlight = function (d, highlight, xRange, yRange) {
        // TODO Create x, width, y, and height functions to combine the calculations for both the highlight bar and the other bars.
        var x = xRange(d.date);
        var MIN_VALUE = this.data.logarithmic ? 1 : 0;
    ...
    TimelineSelectorChart.prototype.clearHighlights = function () {
    ...
    TimelineSelectorChart.prototype.showTooltip = function (item, mouseEvent) {
    ...
    TimelineSelectorChart.prototype.positionTooltip = function (tooltip, mouseEvent) {
    ...
    TimelineSelectorChart.prototype.hideTooltip = function () {
        $(TOOLTIP_ID).hide();
    };
    return TimelineSelectorChart;
}());
export { TimelineSelectorChart };
//# sourceMappingURL=TimelineSelectorChart.js.map