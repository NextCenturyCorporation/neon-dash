...
describe('Component: MediaViewer', () => {
    ...
    it('does show settings icon button in toolbar', (() => {
        let button = fixture.debugElement.query(By.css('.visualization-sidenav mat-toolbar button'));
    ...
    it('does hide tabs if tabsAndMedia is empty', () => {
        let tabs = fixture.debugElement.queryAll(By.css('.visualization-sidenav mat-tab-group .mat-tab-label'));
        expect(tabs.length).toBe(0);
        let slider = fixture.debugElement.queryAll(By.css('.visualization-sidenav mat-tab-group mat-slider'));
    ...
    it('does show single image tag according to the image type', () => {
        ...
        let media = fixture.debugElement.queryAll(By.css('.visualization-sidenav .single-medium'));
    ...
    it('does show multiple image tags in tabs according to the image type', () => {
        ...
        let tabs = fixture.debugElement.queryAll(By.css('.visualization-sidenav mat-tab-group .mat-tab-label'));
        expect(tabs.length).toBe(2);
        let media = fixture.debugElement.queryAll(By.css('.visualization-sidenav mat-tab-group mat-tab-body > div > div'));
        expect(media.length).toBe(1);
        expect(media[0].nativeElement.innerHTML).toContain('<img');
        expect(media[0].nativeElement.innerHTML).toContain('src="' + imgSrc + '" alt="testName"');
    });
    ...
    it('does show two tabs and slider', () => {
        ...
        let slider = fixture.debugElement.queryAll(By.css('.visualization-sidenav mat-slider'));
    ...
    it('does show two images and slider', () => {
        ...
        let medium = fixture.debugElement.queryAll(By.css('.visualization-sidenav .single-medium'));
        expect(medium.length).toBe(1);
        let images = fixture.debugElement.queryAll(By.css('.visualization-sidenav .single-medium img'));
