...
export class AggregationComponent extends BaseNeonComponent implements OnInit, OnDestroy, AfterViewInit, AggregationSubcomponentListener {
    ...
    createNonFieldOptions(): WidgetOption[] {
        return [
            ...
            new WidgetNumberOption('scaleMinX', 'Scale Min X', 0, this.optionsTypeUsesGrid.bind(this)),
            new WidgetNumberOption('scaleMaxX', 'Scale Max X', 100, this.optionsTypeUsesGrid.bind(this)),
            new WidgetNumberOption('scaleMinY', 'Scale Min Y', 0, this.optionsTypeUsesGrid.bind(this)),
            new WidgetNumberOption('scaleMaxY', 'Scale Max Y', 10, this.optionsTypeUsesGrid.bind(this)),
