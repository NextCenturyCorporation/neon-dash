...
export abstract class BaseNeonComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    public createSharedFilters(options: any): FilterClause[] {
        ...
        // TODO THOR-941 FilterService.getFilters must return FilterClause[] (don't depend on neon.query.Filter or WhereWrapper class)
        let filters: FilterClause[] = this.filterService.getFilters({
