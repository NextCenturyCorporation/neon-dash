...
export class SearchService extends AbstractSearchService {
     ...
     * @override
     */
    public buildDateQueryGroup(groupField: string, interval: TimeInterval): CoreGroupWrapper {
        return new CoreGroupWrapper(new query.GroupByFunctionClause('' + interval, groupField, '_' + interval));
    }
