		...
		return E = {
				...
				callPlugin : function() {
					...
					this.depMaps.push(r), u(r, "defined", bind(this, function(r) {
						...
						return this.map.unnormalized ? (r.normalize && (l = r.normalize(l, function(e) {
						...
						})), d = getOwn(k, o.id), void (d && (this.depMaps.push(o), this.events.error && d.on("error", bind(this, function(e) {
							this.emit("error", e)
							...
							var o = e.name,
								u = a(o),
								d = useInteractive;
							r && (i = r), d && (useInteractive = !1), s(u), hasProp(y.config, t) && (y.config[o] = y.config[t]);try {
								req.exec(i)
							} catch (e) {
